...
Because [action results](/neuro-sdk-docs/base/actions/result) packets are meant to be sent as soon as possible after validating incoming packets, we should use both action result packets and context packets to send validation and results separately.
