...
To set up Randy, begin by cloning the Neuro Game SDK repo:
<Code code="git clone https://github.com/VedalAI/neuro-game-sdk" lang="sh" />

Then, navigate into the `Randy` subdirectory:
<Code code="cd Randy" lang="sh" />

Afterwards, install dependencies using your package manager:
...
Once dependencies are installed, start Randy using:
<Tabs syncKey="package-manager">
  <TabItem label="npm">
