...
If you don't have Python version 3.10 or higher, [download the official distribution here](https://python.org/download).

</Aside>

To setup Tony, clone the repository above:

<Code code="git clone https://github.com/Pasu4/neuro-api-tony" lang="sh" />

Then, install dependencies. For the purposes of using, you have as many package managers as there are that support a `pyproject.toml` file.
...
<Tabs syncKey="py-package-manager">
  ...
  <TabItem label="pip">
    <Code code="python3 src/neuro_api_tony/cli.py" lang="sh" />
  </TabItem>
</Tabs>
...
After the GUI pops up, there is a small panel at the bottom right that allows you to configure Tony post-start.
